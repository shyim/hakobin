...
func TestValidatePublicURL(t *testing.T) {
	...
	invalid := []string{
		"packages.example.com", "ftp://example.com", "://nohost", "https://",
		// userinfo, query, and fragment are rejected for repository base URLs.
		"https://user:pass@packages.example.com",
		"https://packages.example.com?token=abc",
		"https://packages.example.com/repo#frag",
	}
